...
const Form7=({number,onNext})=>{
    return(
     ...
     <div id="leftDiv">
      ...
      <p>We sent Verification Code to &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span className="number">{number}</span><a href="">Edit</a></p>
      <p> Enter the code in below boxes</p>
      <ul id='boxes'>
          <li className='box'><input className="handleinput" /></li>
          <li className='box'><input className="handleinput" /></li>
          <li className='box'><input className="handleinput" /></li>
          <li className='box'><input className="handleinput" /></li>
          <li className='box'><input className="handleinput" /></li>
